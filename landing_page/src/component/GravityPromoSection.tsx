  ...
  return (
    <section ref={containerRef} className="w-full py-32 flex flex-col items-center justify-center min-h-[60vh]">
      ...
      <div ref={socialRef} className="flex items-center gap-8">
        <a href="#" className="text-white hover:text-[#FF3C00] transition-colors hover:scale-110 transform duration-300"><Instagram size={24} /></a>
        <a href="#" className="text-white hover:text-[#FF3C00] transition-colors hover:scale-110 transform duration-300"><Twitter size={24} /></a>
        <a href="#" className="text-white hover:text-[#FF3C00] transition-colors hover:scale-110 transform duration-300"><Youtube size={24} /></a>
      </div>
    </section>
  );
}