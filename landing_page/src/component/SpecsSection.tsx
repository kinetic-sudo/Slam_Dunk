...
export default function SpecsSection() {
  ...
  useGSAP(() => {
    ...
    // Floating animation for callouts
      ...
      <div className="max-w-7xl mx-auto px-6 relative flex justify-center items-center min-h-[600px]">
        ...
        <div className="w-[300px] md:w-[400px] aspect-square relative z-10">
          <img 
            ...
            style={{ filter: 'contrast(1.2) saturate(1.5) hue-rotate(340deg)' }} // Make it look more red
          />
        </div>
        ...
        <div ref={calloutsRef} className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-[20%] left-[10%] md:left-[20%] flex items-center gap-4">
            <div className="font-heading text-sm md:text-base text-white uppercase tracking-wider bg-[#111111]/80 px-4 py-2 rounded border border-[#333] backdrop-blur-sm">
              High-Tack Surface
            </div>
